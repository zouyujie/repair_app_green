...
(function(win, mui) {
	/**
	 * @description 本地存储 ：http://ask.dcloud.net.cn/article/552
	 */
	var myStorage = {};
	...
	localStorage.getLengthPlus = getLengthPlus;
	...
	localStorage.getItemByIndex = getItemByIndex;
	 ...
	 */
	localStorage.removeItemByKeys = function(keys, cb) {
